    ...
    <v-container>
      ...
      <v-card v-else elevation="0">
        <v-row justify="center">
          <v-chip-group active-class="active-filter-review" mandatory>
              ...
              <v-card-actions class="pa-4 pb-0">
                <span class="font-weight-bold font-nunito primary--text ma-0">
                  ...
                  <h6 style="display: inline" class="font-weight-light">
                    {{
                      review.r_datetime.substr(
                        0,
                        review.r_datetime.indexOf(" ")
                      )
                    }}
                  </h6>
                </span>
...
export default {
  ...
  methods: {
    ...
    async getBusinessReviews() {
      ...
      this.businessReviews = this.businessReviews.sort(
        (a, b) => a.r_datetime > b.r_datetime
      );
      this.getAllRates();
    },
    getAllRates() {
      ...
      this.businessReviews.forEach((prod) => {
        for (i; i < REVIEWS_SIZE; i++) {
          ...
          } else this.value[this.businessReviews[i].r_rate - 1]++;
